...
汇编语言（第4版） 和韩宏老师的《老码识途 从机器码到框架的系统观逆向修炼之路》 
...
嵌入汇编有两种方式:1_asm{ .... }，在花括号中填写多条汇 编语句;2_asm一条汇编语句，如“_asmmov eax, 1”。例如，C语 言中获取标签的地址值:
    void * address;
    _lb1:
    gi = 12;
    _asm mov address, offset _lb1;
变量address中保存的是标签_lb1所在的地址，即“gi=12;”语 句的地址。
